...
public class Transicion_Dinosaurio extends AppCompatActivity {
    private ViewPager pager;
    private LinearLayout linear;
    private Slide_Dato_Curioso_Transicion sliderAdapter;
    private TextView[] nn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transicion_dinosaurio);
        pager=findViewById(R.id.sliderrr);
        linear=findViewById(R.id.line);
        sliderAdapter=new Slide_Dato_Curioso_Transicion(this);
    ...
    private void iniciarActividad(){
        ...
        Intent inte=new Intent(Transicion_Dinosaurio.this, Formulario_Datos_Usuario.class);
